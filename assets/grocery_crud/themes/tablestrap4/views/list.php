<table cellpadding="0" cellspacing="0" class="display groceryCrudTable table table-striped table-hover" id="<?php echo uniqid(); ?>">
	<thead>
		<tr>
			...
			<td class='actions'>
				<?php if(!empty($row->action_urls)){
					foreach($row->action_urls as $action_unique_id => $action_url){
						...
						<a href="<?php echo $action_url; ?>" class="edit_button btn btn-xs btn-info col-12" role="button">
				...
				<?php if(!$unset_read){?>
					<a href="<?php echo $row->read_url?>" class="edit_button btn btn-xs btn-info btn-sm col-12" role="button">
                ...
                <?php if(!$unset_clone){?>
                    <a href="<?php echo $row->clone_url?>" class="edit_button btn btn-xs btn-info btn-sm hidden-xs col-12" role="button">
				...
				<?php if(!$unset_edit){?>
					<a href="<?php echo $row->edit_url?>" class="edit_button btn btn-xs btn-warning btn-sm hidden-xs col-12" role="button">
				...
				<?php if(!$unset_delete){?>
					<a onclick = "javascript: return delete_row('<?php echo $row->delete_url?>', '<?php echo $num_row?>')"
						href="javascript:void(0)" class="delete_button btn btn-xs btn-danger btn-sm hidden-xs col-12" role="button">
